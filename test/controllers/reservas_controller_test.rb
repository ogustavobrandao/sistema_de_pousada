...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference("Reserva.count") do
      post reservas_url, params: { reserva: { cliente_nome: @reserva.cliente_nome, data_reserva: @reserva.data_reserva, quarto_id: @reserva.quarto_id, status: @reserva.status } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { cliente_nome: @reserva.cliente_nome, data_reserva: @reserva.data_reserva, quarto_id: @reserva.quarto_id, status: @reserva.status } }
